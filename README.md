...
Once you created filesystem search index by pressing "Refresh Index" buttin you can quickly do your searches unlimited number of times.
...
- You can hide columns that you don't need (right mouse click on column header).
...
- Avility to minimize application to system tray
